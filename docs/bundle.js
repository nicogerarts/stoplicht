...
const repeat_1 = __webpack_require__(/*! lit-html/directives/repeat */ "./node_modules/lit-html/directives/repeat.js");
const icons_1 = __webpack_require__(/*! ../icons */ "./src/icons.ts");
var Status;
(function (Status) {
    Status[Status["Red"] = 0] = "Red";
    Status[Status["Orange"] = 1] = "Orange";
    Status[Status["Yellow"] = 2] = "Yellow";
    Status[Status["Green"] = 3] = "Green";
})(Status || (Status = {}));
var Sorting;
(function (Sorting) {
    Sorting["Original"] = "Ongesorteerd";
    Sorting["Name"] = "Naam";
    Sorting["Status"] = "Status";
})(Sorting || (Sorting = {}));
const SORTING_DEFAULT = Sorting.Original;
const status = ({
    [Status.Red]: 'red',
 ...
 * App root component
 */
let App = class App extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        this.sorting = SORTING_DEFAULT;
        this.items = [];
        this.shiftOn = false;
        /**
         * Render function
        ...
        this.render = () => {
            ...
            <div class="appRoot">
                <div class="topControls">
                    <div class="tabs">
                        ${Object.keys(Sorting).map((k) => lit_element_1.html `
                            <div
                                class="tab ${Sorting[k] === this.sorting ? 'active' : ''}"
                                @click="${() => {
                this.sorting = Sorting[k];
            }}"
                            >
                                ${Sorting[k]}
                            </div>
                ...
                <div class="items">
                    ${repeat_1.repeat(items, (o) => o.key, (o) => lit_element_1.html `
                        <div
                ...
                if (root) {
                    const input = root.querySelector(`#input_${o.index[Sorting.Original]}`);
                    if (input) {
                ...
                if ((e.keyCode === 9 && !this.shiftOn) || e.keyCode === 13 || e.keyCode === 40) {
                    ...
                    const found = items.find((m) => m.index[this.sorting] === o.index[this.sorting] + 1);
                    if (found) {
                        const root = this.shadowRoot;
                        if (root) {
                            const input = root.querySelector(`#input_${found.index[Sorting.Original]}`);
                            if (input) {
                                input.focus();
                            }
                        }
                ...
                this.toggleDots(o.index[Sorting.Original]);
                                    ...
                                    ${icons_1.dots}
                                    ${o.index[Sorting.Original] === this.dotsOpen ? lit_element_1.html `
                                            <div class="dots">
                                                ${Object.keys(status).map((k) => lit_element_1.html `
                                                    <div
        ...
        this.addItem = () => {
            ...
            setTimeout(() => {
                const root = this.shadowRoot;
                if (root) {
                    const input = root.querySelector(`#input_${nextIndex}`);
                    if (input) {
                        input.focus();
                    }
                }
        ...
        this.writeName = (k, n) => {
            this.items = this.items.map((o, i) => i === k ? { ...o, name: n } : o);
        };
        this.writeStatus = (k, s) => {
            this.items = this.items.map((o, i) => i === k ? { ...o, status: s } : o);
        };
    }
    static get styles() {
    ...
    get displayItems() {
        return this.items.map((o, index) => ({ ...o, index: { [Sorting.Original]: index } })).sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase())).sort((a, b) => {
        ...
        }).map((o, index) => ({ ...o, index: { ...o.index, [Sorting.Name]: index } })).sort((a, b) => a.status - b.status).map((o, index) => ({ ...o, index: { ...o.index, [Sorting.Status]: index } })).sort((a, b) => a.index[Sorting.Original] - b.index[Sorting.Original]);
    }
    createItem(n = '', s = Status.Green) {
        return {
            name: n,
            status: s,
            key: Symbol(),
...
], App.prototype, "sorting", void 0);
__decorate([
    lit_element_1.property({ type: Number })
], App.prototype, "dotsOpen", void 0);
__decorate([
    lit_element_1.property({ type: Array })
], App.prototype, "items", void 0);
App = __decorate([
    lit_element_1.customElement('stop-app')
], App);
exports.App = App;
...
Object.defineProperty(exports, "__esModule", { value: true });
__webpack_require__(/*! ./components/App */ "./src/components/App.ts");
